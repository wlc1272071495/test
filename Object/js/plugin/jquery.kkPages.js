...
(function($){
	...
	$.fn.kkPages = function(options){
		...
		return this.each(function(){		
			...
			// 定义分页导航
			var PagesNavHtml = "<div class='pagination-wrapper'><div class=\"Pagination\"><a href=\"javascript:;\" class=\"homePage PageCur\">首页</a><a href=\"javascript:;\" class=\"PagePrev PageCur\">上一页</a><span class=\"Ellipsis\"><b>...</b></span><div class=\"pagesnum\"></div><span class=\"Ellipsis\"><b>...</b></span><a href=\"javascript:;\" class=\"PageNext\">下一页</a><a href=\"javascript:;\" class=\"lastPage\">末页</a><cite class=\"FormNum\">到第<input type=\"text\" name=\"PageNum\" id=\"PageNum\">页</cite><a href=\"javascript:;\" class=\"PageNumOK\">确定</a></div></div>";
			...
			if($AllMth > $Mth){
					...
					var PagesMthTxt = "<span>共有<b>"+$AllMth+"</b>条，每页显示:<b>"+$Mth+"</b>条</span>";
					$this.append(PagesNavHtml).find(".Pagination").prepend(PagesMthTxt);
			...
			function showPages(page){
					...
					$PagesNav.each(function(){
						...
						if(NavText == page){
							...
							if(NavText == 1){
								$PagesPrev.addClass('PageCur');
								$PagesFrist.addClass('PageCur');
								$PagesLast.removeClass('PageCur');
								$PagesNext.removeClass('PageCur');
							}else if(NavText == PagesMth){
								$PagesPrev.removeClass('PageCur');
								$PagesFrist.removeClass('PageCur');
								$PagesLast.addClass('PageCur');
								$PagesNext.addClass('PageCur');
							}else{
								$PagesPrev.removeClass('PageCur');
								$PagesFrist.removeClass('PageCur');
								$PagesLast.removeClass('PageCur');
